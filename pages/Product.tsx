            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-5 flex flex-col gap-8">
                    ...
                    <div>
                            ...
                            {['P', 'M', 'G', 'GG', 'XG'].map(size => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`h-12 border rounded-lg flex items-center justify-center font-bold transition-colors
                                        ${selectedSize === size ? 'border-primary bg-primary/10 text-primary' : 'border-white/10 text-white hover:border-primary/50'}
                                        ${!isAvailable ? 'opacity-30 cursor-not-allowed border-white/5 bg-white/5' : ''}
                                    `}
                                    >
                                        {size}
                                    </button>
                        ...
                        {selectedSize && (
                            <p className="text-xs text-[#92c9a8] mt-2 font-bold">
                                {product.inventory?.[selectedSize] || 0} unidades disponíveis
                            </p>
                        )}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className={`flex-1 h-14 font-black rounded-lg text-lg transition-all flex items-center justify-center gap-2
                            ${selectedSize ? 'bg-primary text-background-dark hover:shadow-[0_0_20px_rgba(43,238,121,0.4)]' : 'bg-gray-700 text-gray-400 cursor-not-allowed'}
                        `}
                            >
